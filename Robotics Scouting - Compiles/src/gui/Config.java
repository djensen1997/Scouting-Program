...
/**
 * This Class Handles first time running of the program and Setting up Basic
 * config settings like team Number and Game Year.
 * 
 * 
 * @author DaneJensen
 *
...
public class Config {
	...
	private void generateConfig() {
		...
		try {
			...
			File imageFolder = new File(
					"/Users/" + System.getProperty("user.name") + "/Documents/Scouting Info/Sponser Images");
	...
	public void writeConfig() {
		// "/Users/" + System.getProperty("user.name") + "/Documents/Scouting
		// Info/Config.txt"
		...
		File metric = new File(
				"/Users/" + System.getProperty("user.name") + "/Documents/Scouting Info/" + gameYear + "/metrics/");
	...
	/**
	 * Sets the Team Number for the using Team -Note: This Number is only used
	 * for Cosmetic Purposes
	 * 
	 * @param team
	 *            the team number for the user (Purly Cosmetic)
	 */
	...
	/**
	 * Sets the Game Year for the current game being scouted for -Used to sort
	 * different games and keep metrics and competitions separate
	 * 
	 * @param year
	 *            The year of the Game Being Scouted for
	 */
	 ...
	 * 
	 * @param Password
	 *            The Admin Password for the Program
	 */
	...
	/**
	 * Launches the Main Program, last thing to get called in this class, after
	 * every config setting has been set
	 */
